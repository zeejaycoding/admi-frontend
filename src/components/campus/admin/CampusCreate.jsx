...
const CampusCreate = ({ onSuccess, onCancel }) => {
  ...
  const onSubmit = async (data) => {
    try {
      await dispatch(createCampus(data)).unwrap();
      reset();
      onSuccess();
    } catch (error) {
      notify.error('Failed to create campus. Please try again.');
    }
  };
  ...
  return (
    <CampusFormLayout
      ...
      subtitle="Add a new campus location to your network"
